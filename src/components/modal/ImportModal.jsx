...
const ImportModal = ({ onClose }) => {
  ...
  return (
    <div
      className="fixed top-0 left-0 w-screen h-screen bg-black/60 z-100 flex justify-center items-center"
      onClick={onClose}
    >
      <div
        className="w-[50%] h-[70%] bg-tertiary border-2 border-dashed border-white/40 rounded-lg flex flex-col items-center justify-center cursor-pointer"
        onClick={(e) => {
          e.stopPropagation();
