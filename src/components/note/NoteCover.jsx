...
const NoteCover = ({ note, fetchNotes, fetchBookmarks, page }) => {
  ...
  return (
    <div className="h-56 w-full relative rounded-xl border border-primary/50 bg-neutral-900 hover:border-primary hover:shadow-primary hover:shadow-md transition-all duration-300">
      <Link to={`/notes/${note.id}`} className="block h-full w-full">
